...
import com.minh.gameobject.BackgroundMap;
import com.minh.gameobject.BulletManager;
import com.minh.gameobject.Camera;
import com.minh.gameobject.DarkRaise;
import com.minh.gameobject.FinalBoss;
import com.minh.gameobject.MegaMan;
import com.minh.gameobject.ParticularObject;
import com.minh.gameobject.ParticularObjectManager;
import com.minh.gameobject.PhysicalMap;
import com.minh.gameobject.RedEyeDevil;
import com.minh.gameobject.RobotR;
import com.minh.gameobject.SmallRedGun;
...
public class GameWorldState extends State {
    ...
    public GameWorldState(GamePanel gamePanel) {
        ...
        texts1[0] = "Hello, I'm Deku and I learned to make this game";
        texts1[1] = "Press W A S D to move, space to jump, J to shoot";
            ...
            case KeyEvent.VK_ENTER:
                if (state == GameWorldState.INIT_GAME) {
                    if (previousState == GameWorldState.GAMEPLAY) {
                        ...
                        switchState(GameWorldState.TUTORIAL);
                    }
